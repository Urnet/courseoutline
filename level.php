	...
	<!-- <section class="course-section spad"> -->
		<!-- <div class="container">
			<div class="section-title mb-0">
				<h2>Schools in FPB Bida</h2>
				<p>The following are schools presently running in FPB</p>
			</div>
		</div> -->
		<div class="course-warp section-title">
        <h4>Courses in each Level</h4>
			<ul class="course-filter controls">
				<li class="control active" data-filter="all">All</li>
				<li class="control" data-filter=".finance">ND II</li>
				<li class="control" data-filter=".design">ND I</li>
				<li class="control" data-filter=".web">HND I</li>
				<li class="control" data-filter=".photo">HND II</li>
				<?php include_once "level_nav.php";?>
			</ul>                                       
